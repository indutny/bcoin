...
exports.flags = {
  ...
  VERIFY_DISCOURAGE_UNKNOWN_ANNEX: 1 << 19,
  VERIFY_DISCOURAGE_OP_SUCCESS: 1 << 20,
  VERIFY_DISCOURAGE_UPGRADABLE_PUBKEYTYPE: 1 << 21
};
...
exports.flags.STANDARD_VERIFY_FLAGS = 0
  ...
  | exports.flags.VERIFY_TAPROOT
  | exports.flags.VERIFY_DISCOURAGE_UPGRADABLE_TAPROOT_VERSION
  | exports.flags.VERIFY_DISCOURAGE_UNKNOWN_ANNEX
  | exports.flags.VERIFY_DISCOURAGE_OP_SUCCESS
  | exports.flags.VERIFY_DISCOURAGE_UPGRADABLE_PUBKEYTYPE;
...
/**
 * Transaction serialization digests for signing.
 * @enum {Number}
 */
...
/**
 * Transaction digests by value.
 * @const {Object}
 */

exports.digestsByVal = {
  0: 'LEGACY',
  1: 'WITNESSV0',
  2: 'TAPROOT'
};
...
/**
 * Test if a Sighash type is valid for Taproot.
 * @param {Number} type
 * @returns {Boolean}
 */

exports.isTaprootHashType = function isTaprootHashType(type) {
  return [0x00, 0x01, 0x02, 0x03, 0x81, 0x82, 0x83].includes(type);
};
